...
- **`TECH.md`** at the repo root - the React Native / Expo / Apple / Google stack glossary (provisioning profile, AAB, keystore, track). Use these terms; do not drift to synonyms.
