...
- **App ID (Bundle ID)** — the unique id (`com.example.sampleapp`). Launch registers it via `POST /v1/bundleIds`. → no portal trip.
...
```
launch build ios --profile production [--app sampleapp] [--explain] [--dry-run]
