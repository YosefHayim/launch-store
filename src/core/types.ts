...
export interface AppDescriptor {
  ...
  configPath: string;
  /** iOS bundle identifier, e.g. `com.example.sampleapp`. Undefined until prebuild config is read. */
  bundleId?: string;
...
export interface LaunchConfig {
  ...
  storage: string;
  /** Registered name of the build engine to use. Defaults to `fastlane`. */
  buildEngine: string;
