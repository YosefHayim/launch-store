...
export function manifestSignatureKey(channel: string, platform: string, runtimeVersion: string): string {
...
export function historySnapshotKey(channel: string, platform: string, runtimeVersion: string, id: string): string {
...
export function rollbackDirectiveKey(channel: string, platform: string, runtimeVersion: string): string {
