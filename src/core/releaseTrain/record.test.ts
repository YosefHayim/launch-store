...
import { latestTrainRecord, listTrainRecords, readTrainRecord, removeTrainRecord, writeTrainRecord } from "./record.js";
...
describe("release-train record", () => {
  ...
  it("latestTrainRecord prefers a live train over a newer terminal one", () => {
    writeTrainRecord(train({ id: "done-newer", state: "done", createdAt: "2026-06-15T00:00:00.000Z" }), dir);
    writeTrainRecord(train({ id: "running-older", state: "running", createdAt: "2026-06-14T00:00:00.000Z" }), dir);
  ...
  it("latestTrainRecord falls back to the newest terminal train when none are live", () => {
    writeTrainRecord(train({ id: "done-older", state: "done", createdAt: "2026-06-13T00:00:00.000Z" }), dir);
    writeTrainRecord(train({ id: "aborted-newer", state: "aborted", createdAt: "2026-06-16T00:00:00.000Z" }), dir);
