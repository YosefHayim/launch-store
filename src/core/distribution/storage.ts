...
import type { BuildArtifact, LaunchConfig, Platform, StorageProvider } from '../types/index.js';
import { getStorageProvider } from '../services/registry.js';
 ...
 */
export function ensureArtifactPresent(
