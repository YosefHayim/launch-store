...
const PRICED: Record<string, ReleaseAttributesConfig> = { "com.acme.alpha": { pricing: { customerPrice: 9.99 } } };

function makeCtx(api: AscSurfacesApi | null, releaseAttributes?: Record<string, ReleaseAttributesConfig>): PlanContext {
