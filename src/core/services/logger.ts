 ...
 *
 * Color is the violet→cyan Aurora palette (see {@link import("../terminal/aurora.js")}), emitted only on a
...
import { AURORA, auroraPaint, mix, visibleWidth } from '../terminal/aurora.js';
