...
import { loadConfig, writeAppVersion } from '../config/config.js';
...
import { readLastApp, readLastBump, rememberLastRun } from '../distribution/lastRun.js';
...
import { getBuildEngine, getCredentialsProvider, getSubmitter } from '../services/registry.js';
...
import { capture, exists, run } from '../services/exec.js';
