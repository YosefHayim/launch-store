 ...
 */
export type ApnsKeyRecord = Readonly<{
  keyId: string;
  teamId?: string;
  label?: string;
  importedAt: string;
 ...
 */
export type AccountsFile = Readonly<{
  active: string | null;
 ...
 */
export type SigningAssets = Readonly<{
  bundleId: string;
  teamId: string;
  certName: string;
  certSerial: string;
 ...
 */
export type AppleCredentials = Readonly<{
  ascKey: AscKey;
 ...
 */
export type KeystoreAssets = Readonly<{
  path: string;
  alias: string;
 ...
 */
export type AndroidCredentials = Readonly<{
