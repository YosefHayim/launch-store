 ...
 */
export type SkillStep = Readonly<{
 ...
 * `.cursor/rules/<id>.mdc`).
 */
export type ConsumerSkill = Readonly<{
  id: string;
  title: string;
  description: string;
...
export type BaseContext = Readonly<{
  intro: string;
  commandMap: readonly CommandMapRow[];
 ...
 */
export type ContributorRule = Readonly<{
  file: string;
  description: string;
 ...
 */
export type ContributorSkill = Readonly<{
  id: string;
  title: string;
  description: string;
  triggers: readonly string[];
 ...
 * `docs:check`.
 */
export type GeneratedAgentFile = Readonly<{
  path: string;
  body: string;
}>;
