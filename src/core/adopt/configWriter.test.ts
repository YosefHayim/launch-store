...
import type { ProductPiece } from "./types.js";
import type { InAppPurchaseConfig, SubscriptionGroupConfig } from "../types.js";
...
describe("aggregateProductPieces", () => {
  it("folds iap and subscription-group pieces into one AppProducts, dropping empty arms", () => {
    ...
    expect(aggregateProductPieces(pieces)).toEqual({ inAppPurchases: [IAP], subscriptionGroups: [GROUP] });
