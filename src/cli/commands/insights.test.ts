...
import { renderInsights } from '@core/insights/command.js';
import type { ReviewDatum } from '@core/types/insights.js';
...
describe('renderInsights', () => {
  ...
  it('renders a headline, distribution bars, sentiment, and trend', () => {
    ...
    expect(out).toContain('Rating 3.3/5 - 3 reviews - 33% answered');
