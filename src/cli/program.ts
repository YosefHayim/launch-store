...
export const buildProgram = (
  launchVersion = '0.0.0',
  runBareCommand: () => void | Promise<void> = runWizard,
): Command => {
  const program = new Command();
  program
    .name('launch')
    .description(
      'Build and ship your iOS/Android apps to the stores from your own machine - no Expo bill.',
    )
